...
public class Space {
    ...
    public void run() {
        ...
        while (ship.isAlive()) {
            ...
            com.javarush.task.task25.task2515.Space.sleep(300);
        }
    ...
    public static com.javarush.task.task25.task2515.Space game;

    public static void main(String[] args) throws Exception {
        game = new com.javarush.task.task25.task2515.Space(20, 20);
