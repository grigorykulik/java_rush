...
public class CustomTree extends AbstractList<String> implements Cloneable, Serializable {
     ...
     */
    private com.javarush.task.task20.task2028.CustomTree.Entry<String> root;
     ...
     */
    public CustomTree() {
        root = new com.javarush.task.task20.task2028.CustomTree.Entry<String>(null);
    ...
    public String getParent(String value) {
        setValidCollection();
        String s = null;
        for (com.javarush.task.task20.task2028.CustomTree.Entry<String> entry : queue) {
     ...
     */
    private transient ArrayList<com.javarush.task.task20.task2028.CustomTree.Entry<String>> queue;
     ...
     */
    private void setUpCollection(com.javarush.task.task20.task2028.CustomTree.Entry<String> root) {
        queue = new ArrayList<>();
        Queue<com.javarush.task.task20.task2028.CustomTree.Entry<String>> subQueue = new LinkedList<com.javarush.task.task20.task2028.CustomTree.Entry<String>>();
        queue.add(root);
        subQueue.add(root);
        do {
            if (!subQueue.isEmpty()) {
     ...
     */
    private List<com.javarush.task.task20.task2028.CustomTree.Entry<String>> getCollection(com.javarush.task.task20.task2028.CustomTree.Entry<String> entry) {
        ArrayList<com.javarush.task.task20.task2028.CustomTree.Entry<String>> list = new ArrayList<>();
        Queue<com.javarush.task.task20.task2028.CustomTree.Entry<String>> subQueue = new LinkedList<com.javarush.task.task20.task2028.CustomTree.Entry<String>>();
        list.add(entry);
        subQueue.add(entry);
        do {
    ...
    public int lastIndexOf(Object o) {
        String string = String.valueOf(o);
        setValidCollection();
        com.javarush.task.task20.task2028.CustomTree.Entry<String> element = null;
        for (com.javarush.task.task20.task2028.CustomTree.Entry<String> entry : queue) {
            if (entry.elementName.equals(string)) {
                element = entry;
            }
     ...
     */
    private void changeNewLineRootElement(com.javarush.task.task20.task2028.CustomTree.Entry<String> entry, List<com.javarush.task.task20.task2028.CustomTree.Entry<String>> delList) {
        setValidCollection();
        int size = size();
        for (int i = 0; i < size; i++) {
            com.javarush.task.task20.task2028.CustomTree.Entry<String> newEntry = queue.get(i);
            if (newEntry == entry) {
                if (i < size - 1) {
                    newEntry.newLineRootElement = false;
                    for (int k = i + 1; k < size; k++) {
                        com.javarush.task.task20.task2028.CustomTree.Entry<String> newRootEntry = queue.get(k);
                    ...
                    com.javarush.task.task20.task2028.CustomTree.Entry<String> element = getUndelRoot(newEntry.parent, delList);
     ...
     */
    private com.javarush.task.task20.task2028.CustomTree.Entry<String> getUndelRoot(com.javarush.task.task20.task2028.CustomTree.Entry<String> entry, List<com.javarush.task.task20.task2028.CustomTree.Entry<String>> delList) {
        for (com.javarush.task.task20.task2028.CustomTree.Entry<String> element : queue) {
     ...
     */
    private List<com.javarush.task.task20.task2028.CustomTree.Entry<String>> getNewLineRootElementsCollection(com.javarush.task.task20.task2028.CustomTree.Entry<String> entry) {
        ArrayList<com.javarush.task.task20.task2028.CustomTree.Entry<String>> list = new ArrayList<>();
        list.add(entry);
     ...
     */
    private void createChild(com.javarush.task.task20.task2028.CustomTree.Entry<String> parent, String s) {
        com.javarush.task.task20.task2028.CustomTree.Entry<String> newOne = new com.javarush.task.task20.task2028.CustomTree.Entry<String>(s);
     ...
     */
    private void setChild(com.javarush.task.task20.task2028.CustomTree.Entry<String> parent, com.javarush.task.task20.task2028.CustomTree.Entry<String> child) {
        if (parent.availableToAddLeftChildren) {
            parent.leftChild = child;
            parent.availableToAddLeftChildren = false;
            if (parent.newLineRootElement) {
                List<com.javarush.task.task20.task2028.CustomTree.Entry<String>> list = getNewLineRootElementsCollection(parent);
                for (com.javarush.task.task20.task2028.CustomTree.Entry<String> entry : list) {
    ...
    public boolean remove(Object o) {
        ...
        for (int i = 0; i < queue.size(); i++) {
            com.javarush.task.task20.task2028.CustomTree.Entry<String> entry = queue.get(i);
            if (entry.elementName.equals(value)) {
                List<com.javarush.task.task20.task2028.CustomTree.Entry<String>> list = getCollection(entry);
                for (com.javarush.task.task20.task2028.CustomTree.Entry<String> stringEntry : list) {
     ...
     */
    @Override
    protected com.javarush.task.task20.task2028.CustomTree clone() throws CloneNotSupportedException {
        com.javarush.task.task20.task2028.CustomTree customTree = (com.javarush.task.task20.task2028.CustomTree) super.clone();
        return customTree;
    }
    ...
    public boolean equals(Object o) {
        ...
        com.javarush.task.task20.task2028.CustomTree customTree = (com.javarush.task.task20.task2028.CustomTree) o;
        this.setValidCollection();
        customTree.setValidCollection();
        int size = size();
        for (int i = 0; i < size; i++) {
            com.javarush.task.task20.task2028.CustomTree.Entry first = queue.get(i);
            com.javarush.task.task20.task2028.CustomTree.Entry second = customTree.queue.get(i);
    ...
    public ListIterator<String> listIterator() {
        return new com.javarush.task.task20.task2028.CustomTree.SolutionListIterator(0);
    }
    ...
    public ListIterator<String> listIterator(int index) {
        ...
        return new com.javarush.task.task20.task2028.CustomTree.SolutionListIterator(index);
    }
    ...
    public Iterator<String> iterator() {
        return new com.javarush.task.task20.task2028.CustomTree.SolutionIterator();
    }

    private class SolutionIterator implements Iterator<String> {
        volatile ArrayList<com.javarush.task.task20.task2028.CustomTree.Entry<String>> list;
        ...
        public synchronized void remove() {
            ...
            com.javarush.task.task20.task2028.CustomTree.this.remove(list.get(lastReturned).elementName);
            index = lastReturned;
            lastReturned = -1;
            list = queue;
        }
    ...
    private class SolutionListIterator extends com.javarush.task.task20.task2028.CustomTree.SolutionIterator implements ListIterator<String> {
        ...
        public synchronized void add(String s) {
            com.javarush.task.task20.task2028.CustomTree.this.add(s);
            list = queue;
        }
    }
