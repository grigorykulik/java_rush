...
public class Solution {
    public static void main(String[] args) {
        Set<? extends Animal> allAnimals = getAllAnimals(com.javarush.task.task35.task3507.Solution.class.getProtectionDomain().getCodeSource().getLocation().getPath() + com.javarush.task.task35.task3507.Solution.class.getPackage().getName().replaceAll("[.]", "/") + "/data");
