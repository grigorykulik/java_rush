...
public class GameObject {
    ...
    public boolean isCollisionPossible(com.javarush.games.racer.GameObject otherGameObject) {
    ...
    public boolean isCollision(com.javarush.games.racer.GameObject gameObject) {
