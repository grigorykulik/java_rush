...
public class RoadObject extends GameObject {
    ...
    public void move(int boost, List<com.javarush.games.racer.road.RoadObject> roadObjects) {
        this.y += boost;
    }

    public boolean isCollisionWithDistance(com.javarush.games.racer.road.RoadObject roadObject, int distance) {
