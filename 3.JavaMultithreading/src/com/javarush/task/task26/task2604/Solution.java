...
public class Solution extends Thread {
    ...
    private static final Logger log = Logger.getLogger(com.javarush.task.task26.task2604.Solution.class.getName());
    ...
    public static void main(String[] args) {
        new com.javarush.task.task26.task2604.Solution().start();
        new com.javarush.task.task26.task2604.Solution().start();
        new com.javarush.task.task26.task2604.Solution().start();
    }
