...
public class Solution {
    public static void main(String[] args) {
        int classModifiers = com.javarush.task.task21.task2102.Solution.class.getModifiers();
    ...
    private static Method getMainMethod() {
        Method[] methods = com.javarush.task.task21.task2102.Solution.class.getDeclaredMethods();
