...
public class Solution {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        String fileName = com.javarush.task.task29.task2901.Solution.class.getResource("Solution.java").getPath();

        com.javarush.task.task29.task2901.Solution solution = new com.javarush.task.task29.task2901.Solution(fileName);
