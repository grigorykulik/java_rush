...
public class Client {
    ...
    public class SocketThread extends Thread {
        ...
        protected void notifyConnectionStatusChanged(boolean clientConnected) {
            com.javarush.task.task30.task3008.client.Client.this.clientConnected = clientConnected;
            synchronized (com.javarush.task.task30.task3008.client.Client.this) {
                com.javarush.task.task30.task3008.client.Client.this.notify();
            }
        }
    }

    protected com.javarush.task.task30.task3008.client.Client.SocketThread getSocketThread() {
        return new com.javarush.task.task30.task3008.client.Client.SocketThread();
    }
    ...
    public void run() {
        com.javarush.task.task30.task3008.client.Client.SocketThread socketThread = getSocketThread();
    ...
    public static void main(String[] args) {
        com.javarush.task.task30.task3008.client.Client client = new com.javarush.task.task30.task3008.client.Client();
        client.run();
    }
}
