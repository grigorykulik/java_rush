...
public class BotClient extends Client {
    ...
    public static void main(String[] args) {
        ...
        Client client = new com.javarush.task.task30.task3008.client.BotClient();
        client.run();
    }
    ...
    public class BotSocketThread extends SocketThread {
        ...
        protected void clientMainLoop() throws IOException, ClassNotFoundException {
            ...
            com.javarush.task.task30.task3008.client.BotClient.this.sendTextMessage(hello);
        ...
        protected void processIncomingMessage(String message) {
            ...
            if (format != null) {
                ...
                com.javarush.task.task30.task3008.client.BotClient.this.sendTextMessage("Информация для " + split[0] + ": " + answer);
            }
        }
    }
}