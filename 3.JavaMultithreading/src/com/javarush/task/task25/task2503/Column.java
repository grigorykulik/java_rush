...
public enum Column implements Columnable {
     ...
     */
    public static void configureColumns(com.javarush.task.task25.task2503.Column... newOrder) {
     ...
     */
    public static List<com.javarush.task.task25.task2503.Column> getVisibleColumns() {
        List<com.javarush.task.task25.task2503.Column> result = new LinkedList<>();
        int nextIndex = 0;
