...
public class Cat implements Pet {
    ...
    public Sayable toSayable(final int i) {
        class CatPet implements Sayable {
            ...
            public String say() {
                if (i < 1)
                    return com.javarush.task.task24.task2407.Cat.this.name + " спит.";

                StringBuilder sb = new StringBuilder(com.javarush.task.task24.task2407.Cat.this.name).append(" говорит м");
                for (int j = 0; j < i; j++)
                    sb.append("я");
                sb.append("у!");
                return sb.toString();
